...
// creating new books based on our Book model 
// and then closing our connection to the database.


const mongoose = require('mongoose');
const Cinema = require('../models/Movie'); // UpperCase for movie(with upper B!)
...
Movie.deleteMany() // First delete all movies
  .then(() => {
    Movie.create(movies) // Then,create 10 movies
      .then(moviessDocs => {
